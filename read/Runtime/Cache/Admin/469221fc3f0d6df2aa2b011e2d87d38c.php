...
<div class="head">
  <div class="navigation">
      <h1 class="logo"><a href="__APP__/" title="小说阅读网"> 小说阅读网 </a></h1>
        <div class="link-to-book-store"><a href="javascript:;"> 后台登录 </a></div>
        <div class="session">
          <a href="http://www.douban.com/people/48661946/" target="_blank"> <?php echo ($userName); ?> </a>
            <a class="log-out" href="/logout?ck=awBr"> <?php echo ($logout); ?> </a>
...
<div class="login">
  <div class="cont"> </div>
    <div class="login_main">
      <form name="form1" class="loginform" action="__URL__/../check" method="post"  > 
          <ul class="login_list">
