...
<link rel="stylesheet" type="text/css" href="__PUBLIC__/css/read/reg.css" />
...
<div class="login">
  <div class="cont"> </div>
    <div class="login_main">
      <form name="form1" class="loginform" method="post" action="__URL__/add"> 
          <ul class="login_list">
              <li class="login_input">
                    <label id="uhint" for="userName" class="txt_default ">帐号：建议使用邮箱</label>
            ...
            <input value="" id="userPass" name="userPass" tabindex="2" class="input_txt" type="password">
                ...
                <li><button type="button" class="reg_btn" tabindex="5" id="subbtn" value=""></button></li>
            </ul>
        </form>
    </div>
