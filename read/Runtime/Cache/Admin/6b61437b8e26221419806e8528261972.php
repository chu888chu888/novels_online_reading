...
<div class="main">
    ...
    <ul class="bookClassList">
        ...
        <?php if(is_array($bookClass)): $i = 0; $__LIST__ = $bookClass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form id="form1" name="form1" action="__URL__/save?id=<?php echo ($vo["id"]); ?>" method="post" >
            <li><input id="bookClassName" name="bookClassName" type="text" value="<?php echo ($vo["bookClassName"]); ?>" /></li>
