    ...
    <div class="menu">
     ...
     <ul class="book">
        ...
        <li>管理</li>
         ...
         <?php if(is_array($bookcontents)): $i = 0; $__LIST__ = $bookcontents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
               
                  <?php echo ($vo["contentNum"]); ?>.<?php echo ($vo["contentName"]); ?>
                  
                
                
                </li>
             
              <li> <a href="__URL__/../Content_edit?id=<?php echo ($vo["id"]); ?>">编辑</a> / <a href="__URL__/del/id/<?php echo ($vo["id"]); ?>">删除</a></li><?php endforeach; endif; else: echo "" ;endif; ?>	 			
   	</ul> 
